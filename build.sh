...
if [ "$platform" == "darwin" ]; then
    BIN_PATH=$BIN_PATH/bitrubcoin-wallet-gui.app/Contents/MacOS/
elif [ "$platform" == "mingw64" ] || [ "$platform" == "mingw32" ]; then
    MONEROD_EXEC=bitrubcoind.exe
fi
...
$QMAKE ../bitrubcoin-wallet-gui.pro "$CONFIG" || exit
$MAKE || exit 
